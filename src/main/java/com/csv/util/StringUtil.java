...
public class StringUtil {
    ...
    */
    ...
    public static String replace(final String s, 
    		Integer startPos,Integer endPos,final String replacement){
    	if (isEmpty(s)) {
            return EMPTY_STRING;
        }
	 ...
	 * 
	 * 
	 China Mobile: 134、135、136、137、138、139、150、151、157(TD)、158、159、182、183、187、188、183、140、141、142、143、144、146、147、148、149
...
　　   China Telecom: 133、153、180、181、189、（1349卫通）
	...
	public static boolean isMobile(String mobile) {
		...
		Pattern p = Pattern
				.compile("^((13[0-9])|(14[0-9])|(15[0-9])|(17[0-9])|(18[0-9]))\\d{8}$");// complex
