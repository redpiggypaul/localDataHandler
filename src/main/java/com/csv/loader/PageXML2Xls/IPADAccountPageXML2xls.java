 ...
 */
public class IPADAccountPageXML2xls {
    ...
    public static void main(String args[]) throws IOException {
        ...
        try {
            ...
            FileList theL = new FileList(pagePath+"Account/",  tempPath + "checkFileName");
            ArrayList<String> pageXML = theL.getList2Arrary();

            Date date = new Date();
            DateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            String time = format.format(date);
            String targetFile = new String(targetXLSPath + "pageSample_IPAD_Account");
            ...
            for (String theActionFileName : pageXMLFileList) {
                HashMap<String, ElementMapping> theElementMap = readPageXML(pagePath + "Account/", theActionFileName);
