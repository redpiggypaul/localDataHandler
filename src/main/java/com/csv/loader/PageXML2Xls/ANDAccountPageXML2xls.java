 ...
 */
public class ANDAccountPageXML2xls extends ANDBase {
    ...
    public static void main(String args[]) throws IOException {
        ...
        try {
            ...
            FileList theL = new FileList(pagePath + "AccountSetting/", tempPath + "checkFileName");
            ArrayList<String> pageXML = theL.getList2Arrary();

            Date date = new Date();
            DateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            String time = format.format(date);
            String targetFile = new String(targetXLSPath + "pageSample_And_AccountSetting");
            ...
            for (String theActionFileName : pageXMLFileList) {
                if(theActionFileName.endsWith("xml")) {
                    HashMap<String, ElementMapping> theElementMap = readPageXML(pagePath + "AccountSetting//", theActionFileName);
