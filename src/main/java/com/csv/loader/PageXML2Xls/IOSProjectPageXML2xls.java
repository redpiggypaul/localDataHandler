 ...
 */
public class IOSProjectPageXML2xls extends IOSBase{
    ...
    public static void main(String args[]) throws IOException {
        ...
        String pagePath = readProperity.getProValue("pageXML_IOSPath"); // page path  /Users/appledev131/Documents/REXAUTO4/PageXML/iPAD/
        ...
        try {
            ...
            FileList theL = new FileList(pagePath + "ProjectTimeAndExpense/",tempPath + "checkFileName");
            ArrayList<String> pageXML = theL.getList2Arrary();

            Date date = new Date();
            DateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            String time = format.format(date);
            String targetFile = new String(targetXLSPath + "pageSample_IOS_ProjectTimeAndExpense");
            ...
            for (String theActionFileName : pageXMLFileList) {
                HashMap<String, ElementMapping> theElementMap = readPageXML(pagePath + "ProjectTimeAndExpense/", theActionFileName);
