 ...
 */
public class ANDNotifiPageXML2xls extends ANDBase {
    ...
    public static void main(String args[]) throws IOException {
        ...
        try {
            ...
            FileList theL = new FileList(pagePath , tempPath + "checkFileNameRoot");
            ArrayList<String> pageXML = theL.getList2Arrary();

            Date date = new Date();
            DateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            String time = format.format(date);
            String targetFile = new String(targetXLSPath + "pageSample_And_Root");
            ...
            for (String theActionFileName : pageXMLFileList) {
                HashMap<String, ElementMapping> theElementMap = readPageXML(pagePath + "Notification//" , theActionFileName);
