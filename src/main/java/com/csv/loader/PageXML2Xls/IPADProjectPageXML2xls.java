 ...
 */
public class IPADProjectPageXML2xls {
    ...
    public static void main(String args[]) throws IOException {
        ...
        String pagePath = readProperity.getProValue("pageXML_iPADPath"); // page path  /Users/appledev131/Documents/REXAUTO4/PageXML/IOS/
        ...
        try {
            ...
            String targetFile = new String(targetXLSPath + "pageSample_IPAD_ProjectTimeAndExpense");
