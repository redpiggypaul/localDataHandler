 ...
 */
public class IOSRoleFilterPageXML2xls extends  IOSBase{
    ...
    public static void main(String args[]) throws IOException {
        ...
        try {
            ...
            FileList theL = new FileList(pagePath + "RoleFilter/",  tempPath + "checkFileName");
            ArrayList<String> pageXML = theL.getList2Arrary();

            Date date = new Date();
            DateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            String time = format.format(date);
            String targetFile = new String(targetXLSPath + "pageSample_IOS_RoleFilter");
            ...
            for (String theActionFileName : pageXMLFileList) {
                HashMap<String, ElementMapping> theElementMap = readPageXML(pagePath + "RoleFilter/", theActionFileName);
